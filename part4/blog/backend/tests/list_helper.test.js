...
describe('total likes', () => {
  ...
  test('when list has multiple blogs, equals number of total likes', () => {
...
describe('most blogs', () => {
  ...
  test('when list has multiple blogs, equals author with most blogs with number of blogs', () => {
...
describe('most likes', () => {
  ...
  test('when list has multiple blogs, equals author with most likes with number of likes', () => {
